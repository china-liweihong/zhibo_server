			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					<?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><tr>
                        ...
                        <td><input style="width:50px;height:20px;background:#<?php echo ($vo['colour']); ?>;" disabled/></td>
                        <td><img src="<?php echo ($vo['thumb']); ?>" style="height:24px"></td>
                        <td><img src="<?php echo ($vo['thumb_mark']); ?>" style="height:24px"></td>
						<td><?php echo (date("Y-m-d H:i:s",$vo["addtime"])); ?></td>
						
						<td align="center">	
							<a href="<?php echo U('Level/experlevel_edit',array('id'=>$vo['id']));?>" >编辑</a> |
							<a href="<?php echo U('Level/experlevel_del',array('id'=>$vo['id']));?>" class="js-ajax-dialog-btn" data-msg="您确定要删除吗？">删除</a>
						</td>
