...
var JsInterface={
	...
	sendMsg:function(data){
        ...
        var _msg = '';
        if(msgtype==0){
			_msg = '<p><label class ="user_nickname" user_id='+data.ct.uid+'><img src="/wxshare/Public/share/images/level/rank_'+data.ct.level+'.png" style="margin-top: -2px;margin-right:2px;" width="35" height="15" >'+data.ct.user_nicename+'</label> : <font color="#ffffff">进入房间</font></p>'  
        }else if(msgtype == 2) {
			_msg = '<p><label class ="user_nickname" user_id='+data.uid+'><img src="/wxshare/Public/share/images/level/rank_'+data.level+'.png" style="margin-top: -2px;margin-right:2px;" width="35" height="15" >'+data.uname+'</label> : <font color="#ffffff">'+data.ct+'</font></p>'  
        } 
	...
	sendGift:function(data){
		...
		/* var _msg = '<p><label class ="user_nickname" user_id='+data.uid+'><img src="/wxshare/Public/share/images/level/rank_'+data.level+'.png" style="margin-top: -2px;margin-right:2px;" width="35" height="15" >'+data.uname+'</label> : <font color="#E66973">我送了'+data.ct.giftcount+'个'+data.ct.giftname+'</font></p>',evensend  
